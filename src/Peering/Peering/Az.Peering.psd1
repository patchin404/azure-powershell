...
RequiredAssemblies = 'Microsoft.Azure.Management.Peering.dll', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Upgraded AutoMapper to Microsoft.Azure.PowerShell.AutoMapper 8.1.1 [#18721]'
